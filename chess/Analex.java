...
public Analex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("F_D_LAST_MOVE", this), new Integer(102));
	literals.put(new ANTLRHashString("C_O_LAST_MOVE", this), new Integer(99));
	literals.put(new ANTLRHashString("RATIO_WB", this), new Integer(31));
	literals.put(new ANTLRHashString("...", this), new Integer(96));
	literals.put(new ANTLRHashString("MOVE_RANDOMLY_W", this), new Integer(51));
	literals.put(new ANTLRHashString("end_board", this), new Integer(5));
	literals.put(new ANTLRHashString("CAPTURED_PIECE_TYPE", this), new Integer(33));
	...
	literals.put(new ANTLRHashString("CHECKMATE", this), new Integer(22));
	literals.put(new ANTLRHashString("READ_CHR", this), new Integer(105));
	literals.put(new ANTLRHashString("MOD", this), new Integer(106));
	literals.put(new ANTLRHashString("WAIT", this), new Integer(41));
	literals.put(new ANTLRHashString("MOVEMENTS_LIST", this), new Integer(54));
	literals.put(new ANTLRHashString("READ_NUMBER", this), new Integer(103));
	literals.put(new ANTLRHashString("From", this), new Integer(95));
	literals.put(new ANTLRHashString("Play", this), new Integer(92));
	literals.put(new ANTLRHashString("F_O_LAST_MOVE", this), new Integer(100));
	literals.put(new ANTLRHashString("MOVE_PLAYER_B", this), new Integer(50));
	literals.put(new ANTLRHashString("RANDOM_BOARD", this), new Integer(44));
	literals.put(new ANTLRHashString("CASTLING", this), new Integer(35));
	literals.put(new ANTLRHashString("FLO", this), new Integer(87));
	literals.put(new ANTLRHashString("STATE_3D", this), new Integer(55));
	literals.put(new ANTLRHashString("begin_game", this), new Integer(6));
	literals.put(new ANTLRHashString("CHR", this), new Integer(85));
	literals.put(new ANTLRHashString("GENERATE_3D_BOARD", this), new Integer(48));
	literals.put(new ANTLRHashString("POINTS", this), new Integer(26));
	literals.put(new ANTLRHashString("PIECE_COLOR", this), new Integer(25));
	literals.put(new ANTLRHashString("STATE", this), new Integer(53));
	literals.put(new ANTLRHashString("end_variables", this), new Integer(10));
	literals.put(new ANTLRHashString("REMOVE_PIECE", this), new Integer(47));
	literals.put(new ANTLRHashString("If_Chess", this), new Integer(89));
	literals.put(new ANTLRHashString("WRT", this), new Integer(40));
	literals.put(new ANTLRHashString("INT", this), new Integer(84));
	literals.put(new ANTLRHashString("While_Chess", this), new Integer(97));
	literals.put(new ANTLRHashString("READ_STR", this), new Integer(104));
	literals.put(new ANTLRHashString("Play_If", this), new Integer(91));
	literals.put(new ANTLRHashString("End_If_Chess", this), new Integer(90));
	literals.put(new ANTLRHashString("End_While_Chess", this), new Integer(98));
	literals.put(new ANTLRHashString("MOVE_PLAYER_W", this), new Integer(49));
	literals.put(new ANTLRHashString("cnst", this), new Integer(20));
	literals.put(new ANTLRHashString("PIECE_TYPE", this), new Integer(24));
	literals.put(new ANTLRHashString("C_D_LAST_MOVE", this), new Integer(101));
	literals.put(new ANTLRHashString("For_Chess", this), new Integer(94));
	literals.put(new ANTLRHashString("STALEMATE", this), new Integer(23));
	literals.put(new ANTLRHashString("ADD_PIECE", this), new Integer(45));
	literals.put(new ANTLRHashString("SETUP_PIECE", this), new Integer(46));
	literals.put(new ANTLRHashString("CAPTURED_PIECE_COLOR", this), new Integer(34));
	literals.put(new ANTLRHashString("LOG", this), new Integer(88));
	literals.put(new ANTLRHashString("end_game", this), new Integer(7));
	literals.put(new ANTLRHashString("Play_If_Not", this), new Integer(93));
	literals.put(new ANTLRHashString("MOVE_RANDOMLY_B", this), new Integer(52));
	literals.put(new ANTLRHashString("STR", this), new Integer(86));
	literals.put(new ANTLRHashString("RATIO_POINTS_WB", this), new Integer(32));
	literals.put(new ANTLRHashString("CHECK", this), new Integer(21));
}
...
tryAgain:
	...
	public final void mLIT_NUMERO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched3339 = false;
		if ((((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_1.member(LA(2))) && (true))) {
			int _m3339 = mark();
			synPredMatched3339 = true;
			inputState.guessing++;
			try {
				{
				{
				...
				synPredMatched3339 = false;
			}
			rewind(_m3339);
inputState.guessing--;
		}
		if ( synPredMatched3339 ) {
			{
			int _cnt3341=0;
			_loop3341:
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt3341>=1 ) { break _loop3341; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt3345>=1 ) { break _loop3345; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
