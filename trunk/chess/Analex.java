...
public Analex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("F_D_LAST_MOVE", this), new Integer(96));
	literals.put(new ANTLRHashString("C_O_LAST_MOVE", this), new Integer(93));
	...
	literals.put(new ANTLRHashString("From", this), new Integer(91));
	literals.put(new ANTLRHashString("Play", this), new Integer(82));
	literals.put(new ANTLRHashString("C_D_LAST_MOVE", this), new Integer(95));
	...
	literals.put(new ANTLRHashString("READ_STR", this), new Integer(98));
	...
	literals.put(new ANTLRHashString("cnst", this), new Integer(89));
	...
	literals.put(new ANTLRHashString("F_O_LAST_MOVE", this), new Integer(94));
	literals.put(new ANTLRHashString("READ_NUMBER", this), new Integer(97));
	literals.put(new ANTLRHashString("For_Chess", this), new Integer(90));
	...
	literals.put(new ANTLRHashString("READ_CHR", this), new Integer(99));
