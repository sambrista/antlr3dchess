...
public Analex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("F_D_LAST_MOV", this), new Integer(50));
	...
	literals.put(new ANTLRHashString("F_O_LAST_MOV", this), new Integer(49));
	...
	literals.put(new ANTLRHashString("READ_CHR", this), new Integer(88));
	...
	literals.put(new ANTLRHashString("C_O_LAST_MOV", this), new Integer(75));
	literals.put(new ANTLRHashString("C_D_LAST_MOV", this), new Integer(74));
}
			...
			try {
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt1983>=1 ) { break _loop1983; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
		...
		if ( synPredMatched1984 ) {
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt1986>=1 ) { break _loop1986; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt1990>=1 ) { break _loop1990; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
