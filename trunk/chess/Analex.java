...
public Analex(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("RATIO_WB", this), new Integer(52));
	literals.put(new ANTLRHashString("...", this), new Integer(87));
	literals.put(new ANTLRHashString("RATIO_POINTS_WB", this), new Integer(53));
	literals.put(new ANTLRHashString("MOVE_RANDOMLY_B", this), new Integer(35));
	literals.put(new ANTLRHashString("CAPTURED_PIECE_TYPE", this), new Integer(70));
	literals.put(new ANTLRHashString("begin_board", this), new Integer(4));
	literals.put(new ANTLRHashString("Play_If_Not", this), new Integer(25));
	...
	literals.put(new ANTLRHashString("WAIT", this), new Integer(20));
	literals.put(new ANTLRHashString("ADD_PIECE", this), new Integer(28));
	literals.put(new ANTLRHashString("From", this), new Integer(86));
	literals.put(new ANTLRHashString("Play", this), new Integer(81));
	literals.put(new ANTLRHashString("C_D_LAST_MOVE", this), new Integer(90));
	literals.put(new ANTLRHashString("MOVE_PLAYER_B", this), new Integer(33));
	literals.put(new ANTLRHashString("CASTLING", this), new Integer(61));
	literals.put(new ANTLRHashString("FLO", this), new Integer(18));
	literals.put(new ANTLRHashString("begin_game", this), new Integer(6));
	literals.put(new ANTLRHashString("End_While_Chess", this), new Integer(82));
	literals.put(new ANTLRHashString("READ_STR", this), new Integer(93));
	literals.put(new ANTLRHashString("While_Chess", this), new Integer(80));
	literals.put(new ANTLRHashString("REMOVE_PIECE", this), new Integer(30));
	literals.put(new ANTLRHashString("STATE", this), new Integer(36));
	literals.put(new ANTLRHashString("POINTS", this), new Integer(47));
	literals.put(new ANTLRHashString("GENERATE_3D_BOARD", this), new Integer(31));
	literals.put(new ANTLRHashString("CHR", this), new Integer(83));
	literals.put(new ANTLRHashString("PIECE_COLOR", this), new Integer(69));
	literals.put(new ANTLRHashString("end_variables", this), new Integer(10));
	literals.put(new ANTLRHashString("If_Chess", this), new Integer(23));
	literals.put(new ANTLRHashString("WRT", this), new Integer(19));
	literals.put(new ANTLRHashString("INT", this), new Integer(11));
	literals.put(new ANTLRHashString("End_If_Chess", this), new Integer(26));
	literals.put(new ANTLRHashString("Play_If", this), new Integer(24));
	literals.put(new ANTLRHashString("STATE_3D", this), new Integer(38));
	literals.put(new ANTLRHashString("MOVE_PLAYER_W", this), new Integer(32));
	literals.put(new ANTLRHashString("cnst", this), new Integer(13));
	literals.put(new ANTLRHashString("PIECE_TYPE", this), new Integer(68));
	literals.put(new ANTLRHashString("RANDOM_BOARD", this), new Integer(27));
	literals.put(new ANTLRHashString("F_O_LAST_MOVE", this), new Integer(89));
	literals.put(new ANTLRHashString("READ_NUMBER", this), new Integer(92));
	literals.put(new ANTLRHashString("For_Chess", this), new Integer(85));
	literals.put(new ANTLRHashString("STALEMATE", this), new Integer(60));
	literals.put(new ANTLRHashString("MOVEMENTS_LIST", this), new Integer(37));
	literals.put(new ANTLRHashString("SETUP_PIECE", this), new Integer(29));
	literals.put(new ANTLRHashString("READ_CHR", this), new Integer(94));
	literals.put(new ANTLRHashString("CAPTURED_PIECE_COLOR", this), new Integer(71));
	literals.put(new ANTLRHashString("LOG", this), new Integer(84));
	literals.put(new ANTLRHashString("CHECKMATE", this), new Integer(59));
	literals.put(new ANTLRHashString("end_board", this), new Integer(5));
	literals.put(new ANTLRHashString("STR", this), new Integer(17));
	literals.put(new ANTLRHashString("MOVE_RANDOMLY_W", this), new Integer(34));
	literals.put(new ANTLRHashString("CHECK", this), new Integer(58));
}
...
tryAgain:
	...
	public final void mLIT_NUMERO(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		boolean synPredMatched3722 = false;
		if ((((LA(1) >= '0' && LA(1) <= '9')) && (_tokenSet_1.member(LA(2))) && (true))) {
			int _m3722 = mark();
			synPredMatched3722 = true;
			inputState.guessing++;
			try {
				{
				{
				...
				do {
					if (((LA(1) >= '0' && LA(1) <= '9'))) {
						...
						if ( _cnt3721>=1 ) { break _loop3721; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
					}
				...
				synPredMatched3722 = false;
			}
			rewind(_m3722);
inputState.guessing--;
		}
		if ( synPredMatched3722 ) {
			{
			int _cnt3724=0;
			_loop3724:
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt3724>=1 ) { break _loop3724; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
			...
			do {
				if (((LA(1) >= '0' && LA(1) <= '9'))) {
					...
					if ( _cnt3728>=1 ) { break _loop3728; } else {throw new NoViableAltForCharException((char)LA(1), getFilename(), getLine(), getColumn());}
				}
